...
def get_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Enable id_pool_resample_learnable feature. Default is False.",
    )
...
def main(args):
    ...
    transformer = CogVideoXTransformer3DModel.from_pretrained(
        ...
        id_pool_resample_learnable=args.id_pool_resample_learnable,
    )
    ...
    if args.cogvideox_branch_name_or_path:
        logger.info("Loading existing CogVideoX branch weights")
        branch = CogvideoXBranchModel.from_pretrained(
            args.cogvideox_branch_name_or_path,
    ...
    # use_deepspeed_optimizer, use_deepspeed_scheduler = True, True
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                if not loss.requires_grad:
                    raise ValueError("Loss does not require gradients. Check model parameters.")  
